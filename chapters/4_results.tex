...
\begin{figure}[H]
    ...
    \makebox[\textwidth]{\includegraphics[width=200mm]{all_training_results.png} }
    \caption{ 
...
\begin{figure}[H]
    \captionsetup{format=plain}
    \makebox[\textwidth]{\includegraphics[width=200mm]{rf_precision_vs_threshold.png} }
    \caption{ 
...
\begin{figure}[H]
    \captionsetup{format=plain}
    \makebox[\textwidth]{\includegraphics[width=200mm]{rf_total_returns_by_thresholds.png} }
    \caption{ 
...
\begin{figure}[H]
    \captionsetup{format=plain}
    \makebox[\textwidth]{\includegraphics[width=200mm]{all_proportion_insufficient_returns.png} }
    \caption{ 
...
\begin{figure}[H]
    \captionsetup{format=plain}
    \makebox[\textwidth]{\includegraphics[width=200mm]{logistic_total_returns_by_thresholds.png} }
    \caption{ 
