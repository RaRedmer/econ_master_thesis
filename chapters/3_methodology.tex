...
\begin{algorithm}[H]
    ...
    \KwData{ Minute-binned Test-OHLC-Data and its estimated probability signals }
    ...
    \While{ $ row\_number < (max\_row\_number - delta) $ }{
        ...
        \uIf{sufficient probability signal }{
            \uIf{ no currently active position  }{
                open new position under constraint\;
            }
            \uElseIf{  maximum probability pair != active position pair }{
                close current position\;
            }
        }
        \Else{
            \uIf{ currently active position }{
                close current position\;
            }
        }
        \uIf{ currently active position }{
